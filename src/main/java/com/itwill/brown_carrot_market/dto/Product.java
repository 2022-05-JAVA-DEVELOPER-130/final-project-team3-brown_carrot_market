...
public class Product {
	...
	public int p_address_lat;
	public int p_address_lng;
	...
	public int getP_address_lat() {
		return p_address_lat;
	}

	public void setP_address_lat(int p_address_lat) {
		this.p_address_lat = p_address_lat;
	}

	public int getP_address_lng() {
		return p_address_lng;
	}

	public void setP_address_lng(int p_address_lng) {
		this.p_address_lng = p_address_lng;
	}
